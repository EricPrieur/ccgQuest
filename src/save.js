...
export function saveGame(state, saveName = '') {
  const data = {
    ...
    part2Started: !!state.part2Started,
    part2SiegeOver: !!state.part2SiegeOver,
    greatPourActivated: !!state.greatPourActivated,
    chapter2Started: !!state.chapter2Started,
    tunnelExitNode: state.tunnelExitNode || null,
    tunnelExitLocked: !!state.tunnelExitLocked,
    ...
    lastWatchRested: !!state.lastWatchRested,
    lastWatchAudienceComplete: !!state.lastWatchAudienceComplete,
